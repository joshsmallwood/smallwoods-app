...
export default function FrameConfigurator() {
  ...
  // Task 8 v2 completed
  // Task 9 v2 completed
  // Task 10 v2 completed
  // Task 11 v2 completed
  // Task 12 v2 completed
  // Task 1 v3 completed
  // Task 2 v3 completed
  // Task 3 v3 completed
  // Task 4 v3 completed
  ...
  // Task 8 v3 completed
  // Task 9 v3 completed
  // Task 10 v3 completed
  // Task 11 v3 completed
  // Task 12 v3 completed
  // Task 1 v4 completed
  // Task 2 v4 completed
  // Task 3 v4 completed
  // Task 4 v4 completed
  ...
  // Task 8 v4 completed
  // Task 9 v4 completed
  // Task 10 v4 completed
  // Task 11 v4 completed
  // Task 12 v4 completed
  // Task 1 v5 completed
  // Task 2 v5 completed
  // Task 3 v5 completed
  // Task 4 v5 completed
  ...
  // Task 8 v8 completed
  // Task 9 v8 completed
  // Task 10 v8 completed
  // Task 11 v8 completed
  // Task 12 v8 completed
  // Task 1 v9 completed
  // Task 2 v9 completed
  // Task 3 v9 completed
  // Task 4 v9 completed
  ...
  // Task 8 v9 completed
  // Task 9 v9 completed
  // Task 10 v9 completed
  // Task 11 v9 completed
  // Task 12 v9 completed
  // Task 1 v10 completed
  // Task 2 v10 completed
  // Task 3 v10 completed
  // Task 4 v10 completed
  // Task 5 v10 completed
  // Task 6 v10 completed
  // Task 7 v10 completed
  // Task 8 v10 completed
  // Task 9 v10 completed
  // Task 10 v10 completed
  // Task 1 v11 completed
  // Task 2 v11 completed
  // Task 3 v11 completed
  // Task 4 v11 completed
  // Task 5 v11 completed
  // Task 6 v11 completed
  // Task 7 v11 completed
  // Task 8 v11 completed
  // Task 9 v11 completed
  // Task 10 v11 completed
  // Task 11 v11 completed
  // Task 12 v11 completed
  // Task 1 v12 completed
  // Task 2 v12 completed
  // Task 3 v12 completed
  // Task 4 v12 completed
  // Task 5 v12 completed
  // Task 6 v12 completed
  // Task 7 v12 completed
  // Task 8 v12 completed
  // Task 9 v12 completed
  // Task 1 v13 completed
  const addFrame = () => {
            ...
            >
              ...
              <div className="p-2 flex flex-col gap-0.5">
                ...
                <div className="flex items-center justify-between mt-0.5">
                  ...
                  {'badge' in p && p.badge && (
                    <span className="text-[9px] font-bold text-[#1B5A4A] leading-tight">{p.badge}</span>
                  )}
                </div>
              </div>
            </a>
        ...
        >
          ...
          >
            ...
            <div className="px-5 py-3 border-t border-gray-100">
              ...
              <div className="flex justify-between items-center mb-1">
                <span style={{ fontSize: "13px", color: "#c0392b", fontWeight: 600 }}>{isSaleActive() ? '🍀 Lucky You Savings (35% Off)' : '🏷️ Promo Savings (35% Off)'}</span>
